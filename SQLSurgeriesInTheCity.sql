...
hospital_ID         int CONSTRAINT FK_HOSPITAL_doctors_ID FOREIGN KEY(hospital_ID) REFERENCES Hospital --åñëè óäàëÿåòñÿ áîëüíèöà, òî óäàëÿþòñÿ è âñå âðà÷è â íåé
...
INSERT INTO Connection_surgery_doctor(appointment_ID)   --êàæäàÿ îïåðàöèÿ êåì-òî ïðîâîäèòñÿ
...
having  COUNT(doctor_ID) < 3 ORDER BY COUNT(doctor_ID) ASC;     --â êàêîì ãîñïèòàëå íåõâàòêà äîêòîðîâ!!! Íàäî íàíèìàòü íîâûõ ñðî÷íî
...
CREATE PROCEDURE my_proc as
	...
	where dbo.ages(Doctors.data_of_birth)>40                      --âðà÷è, êîò-ûì áîëüøå 40 ëåò
go
execute my_proc
go
...
union                                                --intersect  âûâåäåò îäèíàêîâûå çàïèñè, èõ íåò, à except âñå çàïèñè èç 
													 --ïåðâîé âûáîðêè, íå âêëþ÷àÿ âòîðóþ âûáîðêó, â ìîžì ñëó÷àå òî æå ñàìîå êàê è ïðè union
